      ...
      <div className="container-fluid">
        ...
        <ul className="nav navbar-nav navbar-right">
          ...
          <li className="dropdown profile">
            <a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Emily Hart <span className="caret"></span></a>
            <ul className="dropdown-menu animated fadeInDown">
              <li className="profile-img">
                <img src="../img/profile/picjumbo.com_HNCK4153_resize.jpg" className="profile-img" />
              </li>
              <li>
                <div className="profile-info">
                  <h4 className="username">Emily Hart</h4>
